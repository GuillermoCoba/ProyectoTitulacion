...
$match  = mysqli_num_rows($searchs);
    if($match > 0){
        ...
        $update = "UPDATE servicios SET status='2' WHERE id_servicio='$Id'";
        ...
        $mail_subject = 'Servicio | Concluido'; // Give the email a subject 
        ...
        <tr>
              ...
              <tr>
                <td class="innerpadding bodycopy" style="text-align: justify;padding: 30px 30px 30px 30px;color: #153643;font-family: sans-serif;font-size: 16px;line-height: 22px;">
                  <center>
                    ...
                    <span>Acabas de concluir el servicio con el siguiente ID:</span> 
                    </p>
                    <div>
          ...
          $mail_subjects = 'Servicio | Concluido'; // Give the email a subject 
                ...
                <tr>
                  <td class="innerpadding bodycopy" style="text-align: justify;padding: 30px 30px 30px 30px;color: #153643;font-family: sans-serif;font-size: 16px;line-height: 22px;">
                    <center>
                      ...
                      <span>A continuación se muestra el servicio que fue concluido con el siguiente ID:</span> 
                      </p>
                      <div>
